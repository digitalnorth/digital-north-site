...
const methodSteps = [
  {
    ...
    description: 'We identify and analyze market signals, user behaviors, and emerging patterns to understand the landscape.',
    color: 'from-cyan-500 to-blue-500',
  },
  {
    icon: Target,
    title: 'North Star Positioning',
    description: 'Define your unique value proposition and strategic position in the market that guides all decisions.',
    color: 'from-blue-500 to-indigo-500',
  },
  {
    icon: TrendingUp,
    title: 'Trajectory Design',
    description: 'Chart the optimal path forward with clear milestones, informed by data and aligned with your vision.',
    color: 'from-indigo-500 to-purple-500',
  },
  {
    icon: Navigation,
    title: 'Navigation Execution',
    description: 'Execute with precision, adapting to real-time feedback while maintaining course toward your goals.',
              ...
              >
                <div className="max-w-2xl mx-auto">
                  <div className="relative group">
                    <div className={`absolute inset-0 bg-gradient-to-br ${step.color} blur-3xl opacity-20 group-hover:opacity-30 transition-opacity duration-500`} />
